...
Public Class EXE
    ...
    Public Overloads Shared Function RunExe(ByVal exePath As String, ByVal arg As String, ByVal hideWindow As Boolean, ByVal waitForExit As Boolean) As Integer
    ...
    ''' <param name ="waitForExit">実行終了を待機するか</param>
    ''' <returns>ExitCode</returns>
    Public Overloads Shared Function RunExe(ByVal exePath As String, ByVal hideWindow As Boolean, ByVal waitForExit As Boolean) As Integer
        Try
